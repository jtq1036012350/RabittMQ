package winning.searchwindowtest;
...
public class SearchUtils {
    ...
    /**
     * @param activity
     * @param rlTopTitle  ,标题栏布局
     * @param llFather    ,界面的跟布局
    ...
    private void initViews(String strHint) {
        ...
        ediSearch = (AutoCompleteTextView) searchView.findViewById(R.id.edi_search);
        ...
        popupWindow = new PopupWindow(searchView, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
    ...
    public void showSearchBar() {
        ...
        translateAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                popupWindow.showAtLocation(fatherView, Gravity.CLIP_VERTICAL, 0, statusBarHeight);
                openKeyboard();
            }
        });
    }
